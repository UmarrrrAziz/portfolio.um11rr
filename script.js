...
function ensureVisibleContent() {
    window.setTimeout(() => {
        document.querySelectorAll(".agency-services .reveal, .agency-achievements .reveal, .agency-bottom .reveal, .agency-layers .reveal").forEach((item) => {
